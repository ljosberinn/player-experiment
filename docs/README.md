...
| Folder | Holds |
| --- | --- |
| [knowledge/](knowledge/) | How this codebase works and why. Read before changing anything. |
| [issues/upcoming/](issues/upcoming/) | Work that is not done. One file per issue, workable as written. |
...
Phases are numbered 1–65 and the numbers are permanent: pull requests, commit
...
meant to happen. An `xx-` prefix is work with no place in that order yet.
