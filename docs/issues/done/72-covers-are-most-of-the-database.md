...
`-500`, so a cover fetched by [79b](79b-online-release-lookup.md) needs no
resample.
...
[79b](79b-online-release-lookup.md) fetches 8,045 covers. It is only safe because
...
Before [79b](79b-online-release-lookup.md), not after — a lookup that fetches
