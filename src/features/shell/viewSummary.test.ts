...
describe("what the footer says the view is showing", () => {
  ...
  it("counts groups on a browse view, not the songs behind them", () => {
    // The number that matters on the Releases view is how many releases are
    // on screen. Repeating the library's track count under a grid of covers
  ...
  it("groups the thousands, which is the only readable form at this size", () => {
    ...
    // "12500 releases" is not a number anyone reads at a glance.
    //
