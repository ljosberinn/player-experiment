    ...
    fn export_bindings_filter_ops() {
        ...
        let mut out = String::from(
            "// This file was generated by \
             `cargo test export_bindings_filter_ops`. Do not edit this file manually.\n\
             \n\
        ...
        out.push_str(
            "};\n\
             \n\
             /**\n\
             \x20* Every operator the backend compiles for a field of each kind.\n\
             \x20*\n\
             \x20* The editor offers a subset of this on purpose - see `OPS_BY_KIND`.\n\
             \x20*/\n\
